...
const DeleteDosageDialogBox = ({ setOpen, setFetchData, selected, setSelected }) => {
    ...
    const handleDeleteButton = () => {
        axios.post(
            `http://localhost:8080/Minor_Project/DeleteDosage`, { selected }
        )
        .then(response => {
    ...
    return (
        <Paper className={classes.DeleteDialog}>
            ...
            <div className={classes.DialogContent}>
                <p>The details of this dosage once deleted will not be retrieved.</p>
...
export default DeleteDosageDialogBox;